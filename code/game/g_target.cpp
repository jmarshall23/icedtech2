...
void target_laser_think (gentity_t *self) {
	...
	engine->SV_Trace( &tr, self->s.origin, vec_zero, vec_zero, end, self->s.number, CONTENTS_SOLID|CONTENTS_BODY|CONTENTS_CORPSE);
...
void target_kill_use( gentity_t *self, gentity_t *other, gentity_t *activator ) {
	G_Damage ( activator, NULL, NULL, vec_zero, vec_zero, 100000, DAMAGE_NO_PROTECTION, MOD_TELEFRAG);
}
